  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "24px 16px 48px", lineHeight: 1.65, fontSize: 14 }}>
      <p style={{ marginBottom: 24 }}>
        <Link href="/" style={{ color: "var(--accent, #0066cc)" }}>
          ← Home
        </Link>
      </p>
      <h1 style={{ fontSize: 28, margin: "0 0 16px", color: "var(--text-bright, #e8f0f8)" }}>Privacy Policy</h1>
      <p style={{ color: "var(--text-muted, #718096)", marginTop: 0 }}>
      ...
      <ul style={{ color: "var(--text-muted, #718096)", paddingLeft: 20 }}>
        <li>
      ...
      <p style={{ color: "var(--text-muted, #718096)" }}>
      ...
      <p style={{ color: "var(--text-muted, #718096)" }}>
        ...
        <a href="mailto:privacy@adsgupta.com" style={{ color: "var(--accent, #0066cc)" }}>
      ...
      <p style={{ color: "var(--text-muted, #718096)" }}>
        ...
        <a href="mailto:grievance-in@adsgupta.com" style={{ color: "var(--accent, #0066cc)" }}>
