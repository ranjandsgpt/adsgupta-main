/**
 * TalentOS Landing Page
 * Apple-style dark mode landing with bento grid layout
 * Route: /talentos
 */
...
import {
  Brain, FileText, Mic, Video, Briefcase, Target, Sparkles, 
  ArrowRight, ChevronRight, Upload, Zap, Star, CheckCircle2,
  Play, Users, TrendingUp, Shield, ExternalLink, Bot
} from 'lucide-react';
...
const BentoCard = ({ icon: Icon, title, description, gradient, size = 'normal', delay = 0 }) => (
  ...
  >
    ...
    <div className="relative z-10">
      <div className={`w-12 h-12 rounded-xl ${gradient.replace('bg-gradient-to-br', 'bg-gradient-to-r')} bg-opacity-20 flex items-center justify-center mb-4`}>
        <Icon size={24} className="text-white" />
      </div>
      <h3 className="text-xl font-bold text-white font-['Space_Grotesk'] mb-2">{title}</h3>
...
const TalentOSLanding = () => {
  ...
  const features = [
    {
      ...
      description: 'Upload your resume and paste a job description. Our AI identifies skill gaps and creates a personalized improvement roadmap.',
    ...
    },
    {
      ...
      description: 'Real-time AI interviewer with voice recognition. Get recursive follow-up questions like a senior hiring manager.',
    ...
    },
    {
      ...
      description: 'Focused training for DSP, SSP, Programmatic, and Header Bidding roles. Industry-specific question banks.',
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-bold font-['Space_Grotesk'] tracking-tight mb-6"
            >
            ...
            >
              ...
              practice with a live mock interviewer, and land your dream ad-tech role.
            </motion.p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                      <p className="text-zinc-300 leading-relaxed">
                        "You mentioned experience with Header Bidding. Can you walk me through 
                        how you'd handle latency issues in a multi-wrapper setup with 10+ demand partners?"
                      </p>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <p className="text-3xl md:text-4xl font-bold text-white font-['Space_Grotesk']">
      ...
      {/* Ad-Tech Specialization Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-zinc-400 text-lg leading-relaxed mb-8">
                Our AI interviewer is trained on thousands of real ad-tech interviews. 
                From DSP optimization to header bidding architecture, we've got you covered.
              </p>
              
              <div className="grid grid-cols-2 gap-4">
                {['DSP/SSP Operations', 'Header Bidding', 'Programmatic Buying', 'Ad Operations', 'RTB & Auction Logic', 'Yield Optimization'].map((topic, index) => (
              ...
              <GlowingBorder>
                <div className="p-6 space-y-4">
                  ...
                  <p className="text-white text-lg leading-relaxed">
                    "In a waterfall vs. header bidding setup, how would you measure the true 
                    incremental revenue gain while accounting for latency impact on user experience?"
                  </p>
      ...
      <footer className="relative border-t border-white/5 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-zinc-400 text-sm">TalentOS by AdsGupta © 2026</span>
          </div>
          
          <div className="flex items-center gap-6">
            <Link to="/privacy" className="text-zinc-500 hover:text-white text-sm transition-colors">Privacy</Link>
            <Link to="/terms" className="text-zinc-500 hover:text-white text-sm transition-colors">Terms</Link>
            <a href="https://adsgupta.com" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white text-sm transition-colors flex items-center gap-1">
              AdsGupta <ExternalLink size={12} />
            </a>
          </div>
        </div>
      </footer>
...
export default TalentOSLanding;
