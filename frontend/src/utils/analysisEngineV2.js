...
export const parseUploadedData = (rawData, reportType = 'auto') => {
  ...
  const metricChecks = {
    ...
    sessions: COLUMN_MAPPINGS.sessions,
    pageViews: COLUMN_MAPPINGS.pageViews,
    ...
    unitSessionPct: COLUMN_MAPPINGS.unitSessionPct,
    ctr: COLUMN_MAPPINGS.ctr,
    acos: COLUMN_MAPPINGS.acos,
    cpc: COLUMN_MAPPINGS.cpc,
    roas: COLUMN_MAPPINGS.roas,
    buyBoxPct: COLUMN_MAPPINGS.buyBoxPct,
    title: COLUMN_MAPPINGS.title,
    parentAsin: COLUMN_MAPPINGS.parentAsin,
    childAsin: COLUMN_MAPPINGS.childAsin,
    ...
    date: COLUMN_MAPPINGS.startDate,
