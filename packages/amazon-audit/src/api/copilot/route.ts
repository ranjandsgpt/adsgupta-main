...
import { COPILOT_SYSTEM, buildCopilotUserMessage } from '@adsgupta/amazon-audit/lib/geminiPromptRegistry';
import { MAX_TOKENS_NARRATIVE } from '@adsgupta/amazon-audit/lib/geminiPromptRules';
import { buildAuditContext, type AuditContextInput, type StoreSummarySnapshot } from '@adsgupta/amazon-audit/lib/copilot/contextBuilder';
import { validateCopilotResponse } from '@adsgupta/amazon-audit/lib/copilot/validateResponse';
import { detectQueryAmbiguity } from '@adsgupta/amazon-audit/lib/copilot/queryAmbiguity';
import { assertNoFileReferences, sanitizeTextForGemini } from '@adsgupta/amazon-audit/lib/geminiRequestGuard';
import { logGeminiRequest } from '@adsgupta/amazon-audit/lib/geminiRequestLogger';
import { runQueryIntelligenceAgent } from '@adsgupta/amazon-audit/agents/queryIntelligenceAgent';
import { recordQueryInteraction } from '@adsgupta/amazon-audit/agents/queryInteractionStore';
import { runInsightDiscoveryAgent } from '@adsgupta/amazon-audit/agents/insightDiscoveryAgent';
import { getCalculationAnswer } from '@adsgupta/amazon-audit/lib/copilot/calculationKnowledgeRegistry';
import { getWastedKeywordsExplanation } from '@adsgupta/amazon-audit/agents/wasteKeywordAgent';
import { aggregateReports } from '@adsgupta/amazon-audit/lib/aggregateReports';
import { tripleEngine } from '@adsgupta/amazon-audit/lib/tripleEngine';
...
export async function POST(request: NextRequest) {
  ...
  let feedbackContext = '';
  try {
    const { getFeedbackContextForEngines } = await import('@adsgupta/amazon-audit/audit/agents/humanFeedbackAgent');
    feedbackContext = getFeedbackContextForEngines();
    const { runCentralFeedbackAgent } = await import('@adsgupta/amazon-audit/audit/agents/centralFeedbackAgent');
