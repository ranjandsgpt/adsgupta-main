...
| `ADMIN_USER_1_EMAIL` / `ADMIN_USER_1_PASSWORD` (and `_2`…) | optional | Same plaintext admin creds as **blog.adsgupta.com**. Stored plaintext in `central_users.password_hash` for now (manual inspect/edit in Supabase). |
